...
publishing {
    ...
    repositories {
        maven {
            name = "OSSRH"
            url = uri(if(System.getenv("RELEASE_VERSION").endsWith("-SNAPSHOT")) "https://s01.oss.sonatype.org/service/local/staging/deploy/maven2/" else "https://s01.oss.sonatype.org/content/repositories/snapshots/")
            credentials {
